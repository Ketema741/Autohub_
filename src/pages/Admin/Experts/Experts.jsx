...
const Experts = () => {
    ...
    const currentExperts = data.slice(startIndex, endIndex);
                ...
                <div className="pt-0 pr-4 pb-0 pl-4 mt-0 mr-auto mb-0 ml-auto sm:flex sm:items-center sm:justify-between">
                    <div>
                        <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 dark:text-white md:text-4xl">
                            Vehicle Experts and Experienced people
                        </h2>
                    ...
                    <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                        <div className="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                {currentExperts.length > 0 && currentExperts.map((supplier) => (
                ...
                <div className="items-center hidden md:flex ">
                    <div className="flex items-center">
                        <span className="text-gray-500 text-lg pr-2">
                            Showing {startIndex + 1} - {endIndex} of {totalExperts} Experts
                        </span>
                    </div>
                </div>
