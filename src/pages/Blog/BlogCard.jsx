            ...
            <div className="h-full rounded-xl shadow-cla-blue bg-gradient-to-r from-indigo-50 to-blue-50 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center flex-wrap ">
                  <NavLink to='/blog-detail' className="bg-gradient-to-r from-cyan-400 to-blue-400 hover:scale-105 drop-shadow-md  shadow-cla-blue px-4 py-1 rounded-lg">
                    Learn more
                  </NavLink>
                </div>
              </div>
          ...
          <div className="p-4 md:w-1/3">
            <div className="h-full rounded-xl shadow-cla-violate bg-gradient-to-r from-pink-50 to-red-50 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center flex-wrap ">
                  <NavLink to='/blog-detail' className="bg-gradient-to-r from-orange-300 to-amber-400 hover:scale-105 drop-shadow-md shadow-cla-violate px-4 py-1 rounded-lg">
                    Learn more
                  </NavLink>
                </div>
              </div>
