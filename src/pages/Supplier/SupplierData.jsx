...
import { Stacked, Pie, Button, LineChart, SparkLine, EditItem } from '../../components';
...
const SupplierData = () => {
  const { setColor, setMode, currentMode, currentColor,editItem, setEditItem } = useStateContext();
        ...
        <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white shadow-md rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
                <img class="rounded-t-lg p-8" src={product9} />
                <div className="px-5 pb-5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button type='button'style={{ color: 'white', backgroundColor: currentColor }} onClick={()=>setEditItem(true)} className="text-white  focus:ring-4  font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
                      Edit
                    </button>
                  </div>
                </div>
