        ...
        <section className="text-gray-600 body-font">
            ...
            <div className="flex flex-wrap -m-4">
                ...
                <div className="h-full rounded-xl shadow-cla-blue bg-gradient-to-r from-indigo-50 to-blue-50 overflow-hidden">
                    ...
                    <div className="p-6">
                    <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Washing Service</h2>
                    <h1 className="title-font text-lg font-medium text-gray-600 mb-3">Tsidu Vehicle Service</h1>
                    <p className="leading-relaxed mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
                    <div className="flex items-center flex-wrap ">
                        <button className="bg-gradient-to-r from-cyan-400 to-blue-400 hover:scale-105 drop-shadow-md  shadow-cla-blue px-4 py-1 rounded-lg">View</button>
                ...
                <div className="p-4 md:w-1/3">
                    ...
                    <div className="p-6">
                        <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Centeralized Vehicle Service</h2>
                        <h1 className="title-font text-lg font-medium text-gray-600 mb-3">AutoHub Vehicle Service</h1>
                        <p className="leading-relaxed mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
                        <div className="flex items-center flex-wrap ">
                        <button className="bg-gradient-to-r from-orange-300 to-amber-400 hover:scale-105 drop-shadow-md shadow-cla-violate px-4 py-1 rounded-lg">View</button>
                ...
                <div className="p-4 md:w-1/3">
                    ...
                    <div className="p-6">
                        <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Repair Service</h2>
                        <h1 className="title-font text-lg font-medium text-gray-600 mb-3">Tigena Vehicle Service</h1>
                        <p className="leading-relaxed mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
                        <div className="flex items-center flex-wrap ">
                        <button className="bg-gradient-to-r from-fuchsia-300 to-pink-400 hover:scale-105  shadow-cla-blue px-4 py-1 rounded-lg">View</button>
