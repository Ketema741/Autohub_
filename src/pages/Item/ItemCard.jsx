    ...
    <div tabIndex={0} className="bg-white focus:outline-none mx-2 w-72 xl:mb-0 mb-8">
      ...
      <div className="bg-white">
        ...
        <div className="p-4">
          ...
          {/* <p tabIndex={0} className="focus:outline-none text-xs text-gray-600 mt-2">{item.description}</p> */}
          ...
          <div className="flex items-center justify-between py-4">
            <button tabIndex={0} className="focus:outline-none bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
              Add to cart
            </button>
          </div>
        </div>
