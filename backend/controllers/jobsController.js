...
const jobsAccptenceMail = async (req, res) => {
  try {
    ...
    let mailOptions = {
      subject: `Congrat ${email}! Your application been accepted`,
      Text: `Dear ${name},
  
        Thank you for your interest in our company and for submitting your application for the [Position] role. After careful consideration, we are pleased to inform you that your application has been accepted.
